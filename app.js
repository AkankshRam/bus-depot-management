...
app.post("/DBdriver", function(req,res){
  connection.connect(function(err) {
    ...
    let query="INSERT INTO busdriver VALUES('"+req.body.driverid+"','"+req.body.name+"','"+req.body.dl_no+"',"+req.body.aadhar+",'"+req.body.address+"');";
...
app.post("/DBconductor", function(req,res){
  connection.connect(function(err) {
    ...
    let query="INSERT INTO busconductor VALUES('"+req.body.conductorid+"','"+req.body.name+"','"+req.body.dl_no+"',"+req.body.aadhar+",'"+req.body.address+"');";
...
app.post("/DBaccidents", function(req,res){
  connection.connect(function(err) {
    ...
    let query="INSERT INTO accident VALUES('"+req.body.location+"','"+req.body.date+"','"+req.body.time+"','"+req.body.bus_no+"','"+req.body.driverid+"');";
...
app.post("/DBabsent", function(req,res){
  connection.connect(function(err) {
    ...
    let query="INSERT INTO absent VALUES('"+req.body.driverid+"','"+req.body.date+"');";
    //let query="select * from absent order by driverid,date;";
    connection.query(query, function (err, result, fields) {
      if (err) {
        return console.error('error: ' + err.message);
      }
...
app.post("/DBrevenue", function(req,res){
  connection.connect(function(err) {
    ...
    let query="UPDATE conducts SET revenue = "+req.body.revenue+" WHERE conductorid = '"+req.body.conductorid+"' AND date= '"+req.body.date+"';";
    console.log(10);
    connection.query(query, function (err, result, fields) {
  ...
  connection.connect(function(err) {
    ...
    connection.query(query, function (err, result, fields) {
      ...
      for(let i=0;i<result.length-1;i++){
        if(result[i]['driverid']!=result[i+1]['driverid']){
          if(max>3)
            ans.push(result[i]['driverid']);
          count=1;
          max=1;
        }
        else{
